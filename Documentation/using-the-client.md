...
!!! Deprecated. fleetctl communicates exclusively with a fleet API endpoint, and will no longer require direct access to etcd.

Use the `--endpoint` flag to override the default of `http://127.0.0.1:4001`:
